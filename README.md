...
This project was based on [electron-boilerplate project](https://github.com/szwacz/electron-boilerplate). A huge part of this readme comes from that repository.
If you're interested in binaries, you should check...

# Quick start

After cloning this repo, just do:
```
npm install
npm start
```
...and application will start. Of course server connection won't work because server secrets are not present.
